...
def on_message(client, userdata, msg):
    ...
    if payload_text == "on":
        publish.single(global_pub_topic, 'The light is shining', hostname="broker.emqx.io")
        print("1")
    if payload_text == "off":
        publish.single(global_pub_topic, 'The light is not shining anymore', hostname="broker.emqx.io")
        print("2")
    ########################
    #   End of your code   #
    ########################
