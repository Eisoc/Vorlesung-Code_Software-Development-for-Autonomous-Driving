...
def main(place_name, start_name, end_name):
    ...
    #   End of your code   #
    ########################
    graph_speed = ox.speed.add_edge_speeds(graph, precision=2)
    graph_time = ox.speed.add_edge_travel_times(graph_speed, precision=2)
    travel_time = sum(ox.utils_graph.get_route_edge_attributes(graph_time, route, "travel_time"))
    route_distance = sum(ox.utils_graph.get_route_edge_attributes(graph_time, route, "length"))
