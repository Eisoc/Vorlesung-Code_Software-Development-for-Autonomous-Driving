...
class YourNet(nn.Module):
    ...
    def __init__(self):
        ...
        #   - input_size = 4 * self.dyn_embedding_size 16 (input of 3 * lanes and 1 * object_history)
        #   - hidden_size = self.decoder_size (defined in model_config)32
        #   - num_layers = self.num_layers_dec (defined in model_config)4
        ########################
        #  Start of your code  #
        ########################

        self.dec_rnn = nn.GRU(input_size=4 * self.dyn_embedding_size,
